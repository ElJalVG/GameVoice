...
public class UnitySphinx : MonoBehaviour {
	...
	public static void Init() {
		...
		hmm = Application.dataPath + "/voz/Resources/UnitySphinx/model/ESp/ESp";
		lm = Application.dataPath + "/voz/Resources/UnitySphinx/model/ESp/es-20k.lm";
		dict = Application.dataPath + "/voz/Resources/UnitySphinx/model/ESp/voxforge_es_sphinx.dic";
		jsgf = Application.dataPath + "/voz/Resources/UnitySphinx/model/ESp/animals.gram";
		kws = Application.dataPath + "/voz/Resources/UnitySphinx/model/ESp/keyphrase.list";
